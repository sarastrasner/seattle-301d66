...
const createStudent = (name, age, hometown) => {
  return { name: name,
    age: age,
    hometown: hometown
  };
...
const joe = createStudent('Joe', 'Schmoe', 100);
...
// The above console.log rendered as 'undefined.'
...
//"This" is undefined. Joe is no longer attached to the Student constructor. 
// 2. What is "this" when joe.scopeArrow() is invoked?
//"This" is undefined. Arrow functions can not be used as constructors. Joe is no longer attached to the Student constructor.
// 3. Explain why "this" is different when an arrow function is used.
//Arrow functions do not bind their own this, instead, they inherit the one from the parent scope. Arrow functions can’t be used as constructors. They can’t be called with new.
